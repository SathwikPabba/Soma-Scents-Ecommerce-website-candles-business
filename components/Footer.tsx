      ...
      <div className="container mx-auto px-4 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <img src="/favicon.png" alt="SomaScents Logo" className="h-8 w-8" />
              <h3 className="text-xl font-bold">
                <span className="text-orange-400">Soma</span>Scents
              </h3>
            </div>
            <p className="text-gray-400 leading-relaxed">
              Ignite your senses with our handcrafted candles. Bringing warmth and aroma to every corner of your home,
              ethically made with love.
            </p>
            <p className="text-gray-400 text-sm">
              Premium quality, sustainable materials, and captivating scents for every occasion.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400">Stay updated on new scents and special offers!</p>
            ...
            <div className="flex space-x-4 pt-2">
              <a
                href="https://www.instagram.com/somascents_?igsh=Nmx2enA0eXZ4enRm"
                target="_blank"
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            {/* Copyright */}
            <p className="text-gray-400 text-sm">© {new Date().getFullYear()} SomaScents. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
